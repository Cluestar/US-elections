The Socmint repository is of my works only, but inspired by several online sources. Credit is given to the sources via this readme file, not in the source code to prevent clutter.
